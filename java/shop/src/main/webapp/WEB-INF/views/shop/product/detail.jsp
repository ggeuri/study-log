			...
			<div class="row">
				<div class="col-lg-6">
					<div class="product__details__pic">
						<div
							...
							tabindex="1" style="overflow-y: hidden; outline: none;">

							<%
							for (int i = 0; i < product.getProductImgList().size(); i++) {
							ProductImg productImg = product.getProductImgList().get(i);%>
							<a class="pt active" href="#product-1"> <img
								src="/photo/p<%=product.getProduct_id()%>/<%=productImg.getFilename()%>"
								alt="">
							</a>
							<%
							}
						...
						<div class="product__details__slider__content">
							<div
								class="product__details__pic__slider owl-carousel owl-loaded">

								<div class="owl-stage-outer">
									<div class="owl-stage"
										style="transform: translate3d(0px, 0px, 0px); transition: all; width: 1324px;">
										<%for(ProductImg productImg : product.getProductImgList()){%>
										<div class="owl-item active" style="width: 331px;">
											<img data-hash="product-1" class="product__big__img"
												src="/photo/p<%=product.getProduct_id()%>/<%=productImg.getFilename()%>"alt="">
										</div>
										<%} %>
										<div class="owl-item" style="width: 331px;">
				...
				<div class="col-lg-6">
					<div class="product__details__text">
						...
						<div class="product__details__price"><%=MoneyConverter.format(product.getPrice())%>
							<span><%=MoneyConverter.format(product.getDiscount())%></span>
						</div>
							...
							<ul>
								...
								<li><span>Available color:</span>
									...
									<%for(Color color : product.getColorList()){ %>
										<label for="<%=color.getColor_name() %>"> <input type="radio"
											name="color__radio" id="<%=color.getColor_name() %>" checked=""> <span
								...
								<li><span>Available size:</span>
									...
									<%for(Size size : product.getSizeList()){ %>
										<label for="<%=size.getSize_name() %>-btn" class="active"> <input
											type="radio" id="<%=size.getSize_name() %>-btn"> <%=size.getSize_name() %> 
										</label> 
										<%} %>
									</div></li>
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							...
							style="background-image: url(&quot;img/product/related/rp-1.jpg&quot;);">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							...
							style="background-image: url(&quot;img/product/related/rp-2.jpg&quot;);">
							<ul class="product__hover">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							...
							style="background-image: url(&quot;img/product/related/rp-3.jpg&quot;);">
				...
				<div class="col-lg-3 col-md-4 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							...
							style="background-image: url(&quot;img/product/related/rp-4.jpg&quot;);">
							<ul class="product__hover">
