									...
									<div class="card">
										<div class="card-heading">
											<a data-toggle="collapse" data-target="#collapse<%=i%>"
												class="collapsed" aria-expanded="false"><%=topCategory.getTopname()%></a>
										</div>
										<div id="collapse<%=i%>" class="collapse"
											...
											<div class="card-body">
												<ul>
													...
													%>
													<li><a
														href="/product/list?subcategory_id=<%=subCategory.getSubcategory_id()%>"><%=subCategory.getSubname()%></a></li>
													<%
													}
													%>
												</ul>
						...
						<div class="col-lg-4 col-md-6">
							<div class="product__item">
								<div class="product__item__pic set-bg"
									data-setbg="/photo/p<%=product.getProduct_id()%>/<%=product.getProductImgList().get(0).getFilename()%>"
									style="background-image: url(&quot;img/shop/shop-1.jpg&quot;);">
									<div class="label new">New</div>
									<ul class="product__hover">
										<li><a
											href="/photo/p<%=product.getProduct_id()%>/<%=product.getProductImgList().get(0).getFilename()%>"
								...
								<div class="product__item__text">
									<h6>
										<a
											href="/product/detail?product_id=<%=product.getProduct_id()%>"><%=product.getProduct_name()%></a>
									</h6>
									<div class="rating">
